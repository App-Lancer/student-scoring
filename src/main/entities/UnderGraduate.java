...
public class UnderGraduate extends StudentClass{
	...
	public UnderGraduate(String firstName, String lastName, int age, List<Module> registeredModules, int totalCredits, List<ModuleScore> moduleScores) {
		super(firstName, lastName, age, "UG", totalCredits);
	...
	public boolean isPassed() {
		...
		for(int i=0; i<this.moduleScores.size(); i++) {
			...
			if(40 < tempModuleScore.getPercentage()) {
				passed = false;
				break;
			}
		}
